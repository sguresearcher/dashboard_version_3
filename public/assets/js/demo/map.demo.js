...
// const mapSocket = io("http://10.20.100.172:3330");
// mapSocket.on("connect", (msg) => {

//     const geolocationMap = msg.geo;
//     const mapLat = geolocationMap.latitude || 0;
//     const mapLng = geolocationMap.longitude || 0;

// });
// var attackLocations = [
//     { from: [mapLat, mapLng], to: [-6.943097, 107.633545] }, 
//     // { from: [51.5074, -0.1278], to: [-7.2504, 112.7688] }, 
//     // { from: [35.6895, 139.6917], to: [-6.9147, 107.6098] }, 
//     // { from: [55.7558, 37.6173], to: [-0.789  3, 113.9213] }, 
